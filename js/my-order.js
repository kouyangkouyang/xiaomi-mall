$(function(){
	...
	$('.right .list ul li').click(function(){
		$('.right .list ul li').removeClass('act')
		$(this).addClass('act');
		var index = $('.right .list ul li').index(this);
		$('.right .order-item').attr('id','0');
		$('.right .order-item').eq(index).attr('id','order-item-act')
	})
	
	$('.bot-right .details').click(function(){
		location.assign('./order-details.html')
	})
	
	
	// 立即付款
	$('.bot-right .pay').click(function(){
